...
public class Dialogue implements Disposable
{
    ...
    int CharWidth = 125;
    int CharHeight = 140;
    int CharX = Gdx.graphics.getWidth() - CharWidth;
    int CharY = -20;
    public int height;
    //This class will contain 3 Line in total
    public Dialogue(String a,String b,String c,String name, String Icon, int dur)
    {
        futureTime=0;
    ...
    public Dialogue(String a,String b,String c,String name, int dur)
    {
        futureTime=0;
        stateTime=Gdx.graphics.getDeltaTime();
        dialogueBackground=new Texture(Gdx.files.internal("dialogueBack.png"));
    ...
    public void drawDialogue(SpriteBatch batch, int x, int y, int width, int height)
    {
        ...
        batch.draw(Char, CharX, CharY, CharWidth, CharHeight);
